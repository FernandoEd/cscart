    ...
    <div class="ty-gift-certificate-wishlist ty-column{$columns}">
            ...
            <div class="ty-grid-list__item ty-quick-view-button__wrapper">
                <div class="ty-twishlist-item">
                    <a href="{"gift_certificates.wishlist_delete?gift_cert_wishlist_id=`$gift_key`"|fn_url}" class="cm-post ty-twishlist-item__remove ty-remove" title="{__("remove")}"><i class="ty-remove__icon ty-icon-cancel-circle"></i><span class="ty-remove__txt ty-twishlist-item__txt">{__("remove")}</span></a>
                </div>
