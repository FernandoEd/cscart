...
<?php /*%%SmartyHeaderCode:197312017060c78fdf710f32-14107297%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '197312017060c78fdf710f32-14107297',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60c78fdf7b9fe8_18467841',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c78fdf7b9fe8_18467841')) {function content_60c78fdf7b9fe8_18467841($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_to_json')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\modifier.to_json.php';
?><?php
...
$_tmp6=ob_get_clean();?><?php echo htmlspecialchars(fn_url("products.get_products_list".$_tmp6), ENT_QUOTES, 'UTF-8');?>
"
...
<?php $_tmp7=ob_get_clean();?><?php echo htmlspecialchars(smarty_modifier_to_json(array(array("id"=>0,"text"=>$_tmp7))), ENT_QUOTES, 'UTF-8');?>
"
                    <?php }?>
            >
...
<?php $_tmp8=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['result_title_post']->value, ENT_QUOTES, 'UTF-8');?>
<?php $_tmp9=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item_extended.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"result",'title_pre'=>$_tmp8,'title_post'=>$_tmp9), 0);?>
...
<?php $_tmp10=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selection_title_post']->value, ENT_QUOTES, 'UTF-8');?>
<?php $_tmp11=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item_extended.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"selection",'title_pre'=>$_tmp10,'title_post'=>$_tmp11), 0);?>
...
<?php $_tmp13=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"selection",'title_pre'=>$_tmp12,'title_post'=>$_tmp13), 0);?>
